    ...
    <div class="col-md-8">
        ...
        if (isset($_GET['category'])) {
           ...
           if (isset($_SESSION['user_role']) && $_SESSION['user_role'] == 'admin')  {
            $query = "SELECT * From posts1 WHERE post_category_id = $post_category_id ";
        }
        else {
            $query = "SELECT * From posts1 WHERE post_category_id = $post_category_id AND post_status = 'published' ";
        }

...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        if (isset($_GET['p_id'])) {
          ...
          $query = "SELECT * FROM posts1 WHERE post_author = '{$the_post_author}' ";
        ...
        <p class="lead">
          All Posts by <a href="author_posts/<?php echo $post_user; ?>/<?php echo $post_id; ?>"><?php echo $post_user; ?></a>
        </p>
    ...
    <?php 
         ...
         $query = "UPDATE posts1 SET post_comment_count = post_comment_count + 1 ";
